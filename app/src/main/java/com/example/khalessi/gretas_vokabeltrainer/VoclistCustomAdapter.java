...
/**
 * Created by Alexandra Filbert on 08.01.18.
 */
...
public class VoclistCustomAdapter extends ArrayAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            //LayoutInflater fügt die 4 Items aus der Vacabulary Tabele in die Textviews ein
        ...
        holder.tv_unitId.setText("UnitId: " + vocitem.getUnitId());
